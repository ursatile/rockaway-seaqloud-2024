		...
		protected override void Up(MigrationBuilder migrationBuilder) {
			...
			migrationBuilder.InsertData(
				...
				values: new object[,]
				{
					...
					{ new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa30"), "; DROP TABLE Artists; -- is an avant-garde math rock band known for its complex rhythms and intricate guitar lines. Their sound is a meticulous blend of disjointed, polyrhythmic patterns and unexpected time signature changes.", "'; DROP TABLE Artists; --", "drop-table-artists" },
