...
namespace Rockaway.WebApp.Migrations
{
    ...
    [Migration("20240417110620_AddIdentity")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ce0d5bcf-d29b-4c80-811d-e7a1d76f1dc8",
                            Email = "admin@rockaway.dev",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "ADMIN@ROCKAWAY.DEV",
                            NormalizedUserName = "ADMIN@ROCKAWAY.DEV",
                            PasswordHash = "AQAAAAIAAYagAAAAEF7x1si7kSsfOeLeLKJKmhZTN4iOMTvY8p3R81TqylLiKFByXg2Pgm2vYIx5PhG27A==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "432ba202-6c86-447c-b23a-55b974b6652e",
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.Artist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "; DROP TABLE Artists; -- is an avant-garde math rock band known for its complex rhythms and intricate guitar lines. Their sound is a meticulous blend of disjointed, polyrhythmic patterns and unexpected time signature changes.",
                            Name = "'; DROP TABLE Artists; --",
                            Slug = "drop-table-artists"
                        });
                });
